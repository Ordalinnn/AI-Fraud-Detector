...
TEXT = {
    "🇰🇿 KZ": {
        ...
        "methodology_dataset_body": "Модель {total} мысалда үйретілген ({fraud} алаяқтық, {safe} қауіпсіз), қазақ, орыс және ағылшын тілдерінде, 23-тен астам алаяқтық түрін қамтиды: банк/карта, жеткізу/сыйлық, туыс-алаяқтығы, инвестиция/жұмыс, техникалық қолдау, романтикалық алаяқтық, крипто, QR-код, қайырымдылық, жазылым, SIM-карта, әлеуметтік желі, салық қайтарымы, мұрагерлік алаяқтығы, жалған іскерлік хат-хабар (BEC), AI-дипфейк инвестиция бейнеролдары, жалған \"робот емессіз бе\" тексерулері, жол алымы туралы жалған SMS, AI дауыс клондау арқылы туыс-алаяқтығы, крипто-романтикалық алаяқтық («шошқаны бордақылау»), банктің \"қайта қоңырау шалыңыз\" схемасы, NFC арқылы алаяқтық және үй иесін алдау (нақты FTC мен FBI IC3 есептеріне негізделген). Бастапқы қолмен жазылған мысалдар нақты банк/қызмет атауларымен жүйелі түрде толықтырылды (мысалы, бір үлгіні бірнеше нақты банкке бейімдеу) — бұл деректерді кеңейтудің стандартты әдісі, әр жалғандықты бөлек іздеу емес.",
    ...
    "🇷🇺 RU": {
        ...
        "methodology_dataset_body": "Модель обучена на {total} примерах ({fraud} мошеннических, {safe} безопасных) на казахском, русском и английском языках, охватывающих более 23 типов мошенничества: банк/карта, доставка/приз, аферы с «родственником», инвестиции/работа, техподдержка, романтическое мошенничество, крипто, QR-коды, благотворительность, подписки, SIM-карта, соцсети, налоговый возврат, наследство, компрометацию деловой переписки (BEC), AI-дипфейк видео с инвестициями, фальшивые проверки «я не робот», SMS о неоплаченном проезде по платной дороге, аферы с клонированием голоса родственника через AI, крипто-романтическое мошенничество («откорм свиньи»), схему банка с «перезвоните нам», NFC-мошенничество и обман с арендой жилья (примеры основаны на реальных отчётах FTC и FBI IC3). Исходные вручную написанные примеры были систематически расширены реальными названиями банков и сервисов (например, один и тот же шаблон адаптирован под несколько конкретных банков) — это стандартный метод расширения датасета, а не независимый поиск каждого случая по отдельности.",
    ...
    "🇬🇧 EN": {
        ...
        "methodology_dataset_body": "The model is trained on {total} examples ({fraud} fraud, {safe} safe) in Kazakh, Russian, and English, covering 23+ scam categories: bank/card, delivery/prize, relative-in-trouble scams, investment/job offers, tech support, romance scams, crypto, QR codes, charity, subscriptions, SIM swap, social media, tax refunds, inheritance scams, business email compromise (BEC), AI-generated deepfake investment videos, fake \"verify you're human\" checks, unpaid-toll SMS scams, AI voice-cloning family emergency scams, crypto romance (\"pig butchering\") scams, bank \"call us back\" schemes, NFC tap scams, and landlord impersonation — patterns grounded in real 2025-2026 FTC and FBI IC3 fraud reports. The original hand-written examples were systematically expanded with real bank/service names (e.g. adapting one template across several concrete banks) — a standard dataset-scaling technique, not independently sourced for each individual case.",
