...
TEXT = {
    "🇰🇿 KZ": {
        ...
        "methodology_dataset_body": "Модель {total} қолмен жазылған мысалда үйретілген ({fraud} алаяқтық, {safe} қауіпсіз), қазақ, орыс және ағылшын тілдерінде, 17-ден астам алаяқтық түрін қамтиды: банк/карта, жеткізу/сыйлық, туыс-алаяқтығы, инвестиция/жұмыс, техникалық қолдау, романтикалық алаяқтық, крипто, QR-код, қайырымдылық, жазылым, SIM-карта, әлеуметтік желі, салық қайтарымы, мұрагерлік алаяқтығы, жалған іскерлік хат-хабар (BEC), AI-дипфейк инвестиция бейнеролдары және жалған \"робот емессіз бе\" тексерулері (нақты FTC мен FBI IC3 есептеріне негізделген).",
    ...
    "🇷🇺 RU": {
        ...
        "methodology_dataset_body": "Модель обучена на {total} вручную составленных примерах ({fraud} мошеннических, {safe} безопасных) на казахском, русском и английском языках, охватывающих более 17 типов мошенничества: банк/карта, доставка/приз, аферы с «родственником», инвестиции/работа, техподдержка, романтическое мошенничество, крипто, QR-коды, благотворительность, подписки, SIM-карта, соцсети, налоговый возврат, наследство, компрометацию деловой переписки (BEC), AI-дипфейк видео с инвестициями и фальшивые проверки «я не робот» (примеры основаны на реальных отчётах FTC и FBI IC3).",
    ...
    "🇬🇧 EN": {
        ...
        "methodology_dataset_body": "The model is trained on {total} hand-written examples ({fraud} fraud, {safe} safe) in Kazakh, Russian, and English, covering 17+ scam categories: bank/card, delivery/prize, relative-in-trouble scams, investment/job offers, tech support, romance scams, crypto, QR codes, charity, subscriptions, SIM swap, social media, tax refunds, inheritance scams, business email compromise (BEC), AI-generated deepfake investment videos, and fake \"verify you're human\" checks — patterns grounded in real 2025-2026 FTC and FBI IC3 fraud reports.",
