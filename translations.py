...
TEXT = {
    "🇰🇿 KZ": {
        ...
        "methodology_dataset_body": "Модель {total} қолмен жазылған мысалда үйретілген ({fraud} алаяқтық, {safe} қауіпсіз), қазақ, орыс және ағылшын тілдерінде, 23-тен астам алаяқтық түрін қамтиды: банк/карта, жеткізу/сыйлық, туыс-алаяқтығы, инвестиция/жұмыс, техникалық қолдау, романтикалық алаяқтық, крипто, QR-код, қайырымдылық, жазылым, SIM-карта, әлеуметтік желі, салық қайтарымы, мұрагерлік алаяқтығы, жалған іскерлік хат-хабар (BEC), AI-дипфейк инвестиция бейнеролдары, жалған \"робот емессіз бе\" тексерулері, жол алымы туралы жалған SMS, AI дауыс клондау арқылы туыс-алаяқтығы, крипто-романтикалық алаяқтық («шошқаны бордақылау»), банктің \"қайта қоңырау шалыңыз\" схемасы, NFC арқылы алаяқтық және үй иесін алдау (нақты FTC мен FBI IC3 есептеріне негізделген).",
